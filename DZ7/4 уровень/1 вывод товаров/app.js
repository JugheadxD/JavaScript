...
let products_elem = document.querySelector('.products')
...
function showCategory(category) {
    let sort = products[category];
    let result_products = '';

    sort.forEach(product => {
        result_products += getProductMarkup(product);
    })
    products_elem.insertAdjacentHTML('afterbegin', result_products);
}
